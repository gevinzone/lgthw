...
type Blog struct {
	...
	//  string author = 5;
	Blog       *BlogRequest           `protobuf:"bytes,2,opt,name=blog,proto3" json:"blog,omitempty"`
...
func (x *Blog) GetBlog() *BlogRequest {
	if x != nil {
		return x.Blog
	}
	return nil
...
var file_blog_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x5f, 0x73, 0x6c, 0x75, 0x67, 0x22, 0xb5, 0x01, 0x0a, 0x04, 0x42, 0x6c, 0x6f, 0x67,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	0x12, 0x25, 0x0a, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11,
	0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x12, 0x3a, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74,
...
var file_blog_proto_depIdxs = []int32{
	2, // 0: blog.Blog.blog:type_name -> blog.BlogRequest
	6, // 1: blog.Blog.createTime:type_name -> google.protobuf.Timestamp
	6, // 2: blog.Blog.updateTime:type_name -> google.protobuf.Timestamp
	4, // 3: blog.BlogResponse.response:type_name -> blog.Response
	3, // 4: blog.BlogResponse.blog:type_name -> blog.Blog
	1, // 5: blog.BlogAdmin.GetArticle:input_type -> blog.Id
	2, // 6: blog.BlogAdmin.CreateArticle:input_type -> blog.BlogRequest
	2, // 7: blog.BlogAdmin.UpdateArticle:input_type -> blog.BlogRequest
	1, // 8: blog.BlogAdmin.DeleteArticle:input_type -> blog.Id
	3, // 9: blog.BlogAdmin.GetArticle:output_type -> blog.Blog
	3, // 10: blog.BlogAdmin.CreateArticle:output_type -> blog.Blog
	3, // 11: blog.BlogAdmin.UpdateArticle:output_type -> blog.Blog
	4, // 12: blog.BlogAdmin.DeleteArticle:output_type -> blog.Response
